        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <h2 class="process-hero-title">
                 ...
                 <p>
                  We've made FBR tax services simple, fast, and completely remote.<br class="process-br">
                   No office visits, no long queues, no complex paperwork.
                   Just 4<br class="process-br">
...
<section class="testimonal-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="testimonal-header text-center fade-up delay-1">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="testimonal-card fade-up delay-2">
             ...
             <div class="col-lg-4 col-md-4">
                <div class="testimonal-card fade-up delay-3">
                    <div class="testimonal-reviews">
                      ★★★★★
                    </div>
                    <p class="testimonal-desc">
             ...
             <div class="col-lg-4 col-md-4">
                <div class="testimonal-card fade-up delay-4">
                    <div class="testimonal-reviews">
                      ★★★★★
                    </div>
                    <p class="testimonal-desc">
...
<section class="pro-tips">
  <div class="container">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="pro-tips-header text-center fade-up delay-1">
            <div class="pro-tips-label">
            Pro Tips
            </div>
            <h2 class="pro-tips-title">
               Tips for Faster Processing
            </h2>
            <p class="pro-tips-subtitle">
               How to get your service completed even faster
            </p>
        ...
        <div class="col-lg-4 col-md-4">
          <div class="tip-card  fade-up delay-2">
            <div class="tip-icon">
              <i class="fa fa-id-card"></i>
            </div>
            <h4>Have CNIC Ready</h4>
            <p>Keep clear copies of your CNIC (front &amp; back) on your phone</p>

          </div>

        </div>
         <div class="col-lg-4  col-md-4">
          <div class="tip-card fade-up delay-3">
            <div class="tip-icon">
             <i class="fa fa-mobile-alt"></i>
            </div>
            <h4>Active Mobile Number</h4>
            <p>Ensure your mobile number is registered with NADRA and active</p>

          </div>

        </div>
         <div class="col-lg-4  col-md-4">
          <div class="tip-card fade-up delay-4">
            <div class="tip-icon">
              <i class="fa fa-envelope"></i>
            </div>
            <h4>Valid Email Address</h4>
            <p>Have an active email address that you can access</p>
         ...
         <div class="col-lg-4  col-md-4">
          <div class="tip-card fade-up delay-2">
            ...
            <p>Keep all relevant documents in one folder on your phone</p>
         ...
         <div class="col-lg-4  col-md-4">
          <div class="tip-card fade-up delay-3">
            ...
            <p>Quick responses to our queries speed up the process</p>
         ...
         <div class="col-lg-4  col-md-4">
          <div class="tip-card fade-up delay-4">
            ...
            <h4>Use WhatsApp</h4>
            <p>All communication happens on WhatsApp for fastest turnaround</p>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="quote-card">
          ...
          <p>Follow our simple 4-step process and let our experts handle your tax matters. No office visits, no complex paperwork – just results!</p>
           <a href="#" class="start-whatsapp">
            <i class="fab fa-whatsapp"></i>
           ...
           <p class="small-title">
          Free initial consultation • No commitment required • 100% secure
        </p>
        </div>
